...
export class AddCompanyRelationAndCompanyNameInOrderTable1745834945945
  implements MigrationInterface
{
  name = 'AddCompanyRelationAndCompanyNameInOrderTable1745834945945';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`orders\` ADD \`company_name\` varchar(255) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`orders\` DROP COLUMN \`company_name\``,
    );
    await queryRunner.query(
